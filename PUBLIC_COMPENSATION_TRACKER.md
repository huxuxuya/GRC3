...
| [`P3-CAND-02`](public_cases/P3-CAND-02-negative-coin-balance.md)<br>Negative coin balance / settle-drop<br>[Calculation](https://github.com/gonkavip/unclaimed); [independent audit](public_cases/sources/P3-CAND-02-independent-audit.md); [archive artifacts](artifacts/case2_archive/README.md) | 1-274; focused 87-142 and tail 275-280 checked | Coordinator validated; inclusion pending | Evgenii Maksimenkov | 19 miners; Evgenii Maksimenkov | @maksimenkoff; deterministic affected set calculated in [gonkavip/unclaimed](https://github.com/gonkavip/unclaimed); independent archive validation matched 19 pairs exactly | @dem_ww; coordinator @OpenMindedPerson validated result; required: governance inclusion decision | 1,075.336151 GNK | Chain recorded positive rewards, but no historical `SettleAmount` existed at settlement for the 19 validated rows; rewards were eventually swept into the gov module account. Independent full archive scan found no additional settle-drop candidates in 1-274. | [#550](https://github.com/gonka-ai/gonka/pull/550) (`v0.2.8`) present in current code; full post-fix scan through 274 and tail checks through 280 found no additional settle-drop candidates; [#826](https://github.com/gonka-ai/gonka/pull/826) is a separate claim-time path |
