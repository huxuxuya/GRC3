...
| Epoch 266 nonce | [`p4_problem_02_e266_nonce_scope.md`](p4_problem_02_e266_nonce_scope.md), [`p4_problem_02a_e266_zero_reward_rows.md`](p4_problem_02a_e266_zero_reward_rows.md) | 9 excluded operators confirmed; 5 zero-reward rows are in-final-group `failed_confirmation_poc`; 4 rows are rewarded top-ups. | External attack, reconstruction, zero-reward cause, and top-up eligibility unresolved. | Vote narrow excluded-operator scope separately from top-up/zero-reward rows. |
